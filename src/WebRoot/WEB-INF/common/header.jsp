  ...
  <div class="page-header-inner ">
    ...
    <div class="hor-menu   hidden-sm hidden-xs">
      <ul class="nav navbar-nav">
        ...
        <li class="classic-menu-dropdown <%=request.getParameter("menu").startsWith("conf_") ? "active" : ""%>"><a href="javascript:;" data-hover="megamenu-dropdown" data-close-others="true" class="hover-initialized"> 系统配置 <i class="fa fa-angle-down"></i> <%=request.getParameter("menu").startsWith("conf_") ? "<span class=\"selected\"> </span>" : ""%> </a>
